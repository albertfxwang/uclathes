...
We also show the 2-$\sigma$ spread of the galaxy \mgs from the FIRE cosmological zoom-in simulations \citep{Ma:2016gw}.
...
low-mass regime.
According to \citet{Ma:2016gw}, galactic feedback from intense starburst episodes on 0.1-1 Gyr time scale can effectively flatten 
\mgs.
...
%    The mass complete range is marked by the solid line, and the dashed line is only an extension from the linear fit.
    The 2-$\sigma$ interval of the FIRE simulation results presented by \citet{Ma:2016gw} is
...
%    The \Ha EL of this galaxy is covered by G141 because of its redshift $z=1.25$.
